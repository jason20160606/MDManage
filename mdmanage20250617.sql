...
-- ----------------------------
INSERT INTO `order_items` VALUES (1101, 26, 81, 821.00, 704.00, 146.00);
INSERT INTO `order_items` VALUES (1102, 27, 55, 6.00, 561.00, 1.00);
INSERT INTO `order_items` VALUES (1103, 25, 50, 753.00, 357.00, 336.00);
INSERT INTO `order_items` VALUES (1104, 28, 62, 333.00, 713.00, 351.00);
INSERT INTO `order_items` VALUES (1105, 25, 54, 481.00, 435.00, 302.00);
INSERT INTO `order_items` VALUES (1106, 36, 91, 964.00, 681.00, 724.00);
INSERT INTO `order_items` VALUES (1107, 33, 92, 255.00, 370.00, 766.00);
INSERT INTO `order_items` VALUES (1108, 26, 39, 87.00, 761.00, 258.00);
INSERT INTO `order_items` VALUES (1109, 33, 60, 40.00, 538.00, 178.00);
INSERT INTO `order_items` VALUES (1110, 28, 28, 773.00, 863.00, 733.00);
INSERT INTO `order_items` VALUES (1111, 25, 64, 718.00, 837.00, 135.00);
INSERT INTO `order_items` VALUES (1112, 25, 20, 825.00, 353.00, 613.00);
INSERT INTO `order_items` VALUES (1113, 35, 29, 616.00, 267.00, 20.00);
INSERT INTO `order_items` VALUES (1114, 32, 9, 570.00, 698.00, 412.00);
INSERT INTO `order_items` VALUES (1115, 30, 42, 627.00, 976.00, 301.00);
INSERT INTO `order_items` VALUES (1116, 34, 29, 897.00, 528.00, 740.00);
INSERT INTO `order_items` VALUES (1117, 22, 40, 208.00, 346.00, 523.00);
INSERT INTO `order_items` VALUES (1118, 31, 35, 74.00, 188.00, 173.00);
INSERT INTO `order_items` VALUES (1119, 34, 2, 399.00, 709.00, 0.00);
INSERT INTO `order_items` VALUES (1120, 36, 50, 191.00, 623.00, 35.00);
INSERT INTO `order_items` VALUES (1121, 23, 94, 552.00, 339.00, 407.00);
INSERT INTO `order_items` VALUES (1122, 22, 18, 45.00, 393.00, 34.00);
INSERT INTO `order_items` VALUES (1123, 35, 87, 205.00, 408.00, 838.00);
INSERT INTO `order_items` VALUES (1124, 26, 45, 924.00, 486.00, 845.00);
INSERT INTO `order_items` VALUES (1125, 30, 26, 561.00, 68.00, 448.00);
INSERT INTO `order_items` VALUES (1126, 25, 34, 251.00, 119.00, 664.00);
INSERT INTO `order_items` VALUES (1127, 34, 8, 81.00, 688.00, 726.00);
INSERT INTO `order_items` VALUES (1128, 27, 5, 395.00, 222.00, 272.00);
INSERT INTO `order_items` VALUES (1129, 25, 79, 102.00, 781.00, 710.00);
INSERT INTO `order_items` VALUES (1130, 34, 29, 662.00, 831.00, 547.00);
...
CREATE TABLE `orders`  (
  ...
  `quota_deducted` decimal(18, 2) NULL DEFAULT 0.00 COMMENT '已扣除的库存额度',
  `quota_returned` decimal(18, 2) NULL DEFAULT 0.00 COMMENT '已归还的库存额度',
  `receiver_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '收货人姓名',
  `receiver_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '收货人电话',
  ...
  `delivery_type` tinyint NULL DEFAULT 1 COMMENT '快递类型：1=自提，2=到付，3=现付',
  ...
  INDEX `dealer_id`(`dealer_id` ASC) USING BTREE,
  INDEX `factory_id`(`factory_id` ASC) USING BTREE,
  INDEX `import_id`(`import_id` ASC) USING BTREE,
  INDEX `audit_by`(`audit_by` ASC) USING BTREE,
  ...
  CONSTRAINT `orders_ibfk_5` FOREIGN KEY (`audit_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (22, 'ZO06004333660231', 171, 19, 4, '4', 49823.00, 89395.31, 55.00, 43.00, '李睿', '18862662072', '中国东莞珊瑚路973号20室', '22iRkeFJal', 11, NULL, 1, 11, '2022-07-10 07:05:31', 'LwcSFJAM9p', 588, '2025-01-14 17:40:31', '2018-03-07 21:38:46');
INSERT INTO `orders` VALUES (23, 'OD17635696964161', 116, 2, 4, '1', 44643.00, 20796.77, 445.00, 803.00, '胡睿', '18808734478', '中国中山乐丰六路159号华润大厦15室', 'FuP3T3FcQS', 14, NULL, 1, 14, '2023-11-20 13:31:03', 'wmKqx2iWgu', 262, '2010-04-16 10:17:30', '2018-12-31 17:23:09');
INSERT INTO `orders` VALUES (24, 'BJ93749553585804', 109, 10, 3, '4', 20770.00, 80165.48, 565.00, 440.00, '孟致远', '18887929183', '中国北京市東城区東直門內大街867号34栋', 'lXMIxKMp14', 4, NULL, 1, 4, '2006-02-16 10:23:36', 'eMXmVueMTy', 640, '2023-01-15 22:52:26', '2013-05-23 08:25:19');
INSERT INTO `orders` VALUES (25, 'XY24623470304604', 145, 21, 1, '0', 26682.00, 91143.60, 587.00, 871.00, '顾杰宏', '18857416964', '中国东莞环区南街二巷214号9楼', 's88YDTCKL9', 11, NULL, 1, 11, '2011-06-17 09:21:45', 'QDIcPXdq5T', 682, '2014-06-30 06:09:06', '2023-03-14 19:10:11');
INSERT INTO `orders` VALUES (26, 'BU31154684887067', 172, 20, 4, '4', 13642.00, 3937.03, 854.00, 409.00, '邓致远', '18876902951', '中国中山紫马岭商圈中山五路332号41号楼', 'qmcr3kwt6N', 2, NULL, 1, 2, '2006-08-14 05:34:36', 'fdra5CWctd', 503, '2012-12-04 17:53:41', '2016-07-15 00:39:31');
INSERT INTO `orders` VALUES (27, 'WS50653083741731', 167, 21, 3, '5', 98093.00, 50731.80, 461.00, 253.00, '吕嘉伦', '18801047938', '中国北京市西城区复兴门内大街81号华润大厦38室', 'ykp8Bp3e0I', 2, NULL, 1, 2, '2014-12-16 11:07:47', 'Ac5Bdxem7V', 585, '2023-08-06 00:18:05', '2018-06-13 18:44:13');
INSERT INTO `orders` VALUES (28, 'MI80753626758601', 197, 2, 1, '3', 94081.00, 85354.44, 336.00, 445.00, '贾宇宁', '18871440278', '中国东莞珊瑚路763号华润大厦49室', 'rn8V5GCOL4', 14, NULL, 1, 14, '2003-06-12 06:09:19', 'KpJWvDe3dW', 716, '2021-12-18 11:09:41', '2012-10-25 20:08:38');
INSERT INTO `orders` VALUES (29, 'HH54377728549328', 156, 14, 3, '1', 59682.00, 54219.29, 163.00, 890.00, '姜嘉伦', '18817020177', '中国深圳龙岗区学园一巷998号46栋', '840V8c5X6w', 9, NULL, 1, 9, '2024-11-27 23:38:29', 'huQJbI82e7', 721, '2017-04-13 03:26:01', '2021-09-23 16:19:09');
INSERT INTO `orders` VALUES (30, 'KJ57368622689154', 145, 18, 4, '5', 17280.00, 8317.30, 160.00, 187.00, '于震南', '18854439389', '中国北京市海淀区清河中街68号457号华润大厦24室', 'YtlcOdWO4O', 10, NULL, 1, 10, '2018-10-30 22:06:59', 'H2y57k4gfI', 489, '2010-09-05 11:40:38', '2022-04-22 14:25:09');
INSERT INTO `orders` VALUES (31, 'DE39642216009252', 143, 12, 1, '1', 59181.00, 38341.01, 175.00, 719.00, '许震南', '18803665063', '中国广州市越秀区中山二路295号33楼', 'oVAn5je5dW', 7, NULL, 1, 7, '2008-11-30 21:24:49', 'p1KD7e6jIz', 719, '2012-03-11 21:27:39', '2021-05-08 10:57:10');
INSERT INTO `orders` VALUES (32, 'GV30583345654881', 140, 7, 4, '1', 74014.00, 81200.88, 697.00, 497.00, '林子异', '18802855015', '中国成都市锦江区人民南路四段580号21楼', '2gG0FiBuBY', 5, NULL, 1, 5, '2014-03-19 15:00:07', 'XqHW1KqObV', 293, '2023-02-21 12:43:39', '2006-03-17 08:17:44');
INSERT INTO `orders` VALUES (33, 'XS60161449941330', 143, 20, 1, '1', 15631.00, 35016.78, 195.00, 844.00, '钱致远', '18836677110', '中国北京市东城区东单王府井东街919号36栋', 'kPua8xAxsf', 15, NULL, 1, 15, '2002-11-24 15:28:57', 'iawDIoUUIL', 900, '2024-05-23 14:24:42', '2019-05-31 10:41:03');
INSERT INTO `orders` VALUES (34, 'MA05539834627563', 128, 3, 3, '2', 24087.00, 40444.10, 328.00, 704.00, '武子韬', '18826493752', '中国广州市越秀区中山二路993号14号楼', 'YdpdrJKUah', 8, NULL, 1, 8, '2008-12-29 09:10:56', 'oqIKP6YZgr', 45, '2024-04-10 06:43:38', '2016-06-01 21:37:34');
INSERT INTO `orders` VALUES (35, 'EH11077209136678', 109, 1, 3, '5', 46732.00, 79123.92, 414.00, 122.00, '薛嘉伦', '18880069161', '中国广州市海珠区江南西路809号26号楼', 'S31Qq3KGX2', 11, NULL, 1, 11, '2016-02-08 06:33:03', 'VxfQYuA6sL', 600, '2000-04-15 02:33:20', '2023-11-15 23:41:56');
INSERT INTO `orders` VALUES (36, 'LC66282304759271', 114, 22, 2, '2', 20264.00, 23957.36, 540.00, 990.00, '曹致远', '18872555416', '中国成都市锦江区人民南路四段49号12室', 'VJ4QKtCbZi', 13, NULL, 1, 13, '2001-07-19 22:33:43', 'b8fO9e5ZT5', 325, '2025-04-06 15:19:51', '2004-11-18 11:33:16');
